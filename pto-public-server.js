...
const STATIC_SHARED_BINARY = new Set(['img/lofty-logo.png', 'img/moatable-logo.png', 'img/icon-192.png', 'img/icon-512.png', 'img/icon-512-maskable.png', 'img/apple-touch-icon.png', 'img/csat-banner.png', 'img/learning-thumb-zendesk-sop.png', 'img/learning-thumb-intro-lofty.png', 'img/learning-thumb-jira-training.png', 'img/learning-thumb-ess-training.png', 'vendor/pptxgen.bundle.js', 'vendor/jspdf.umd.min.js']);
